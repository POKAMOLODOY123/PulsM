"""
Generate a debug plot for 'ЭКГ в покое.json' showing:
...
def main() -> None:
    ...
    path = PROJECT_ROOT / "ЭКГ в покое.json"
    ...
    fig = plot_ecg_debug(
        ...
        title="Debug: ЭКГ в покое (prob + features)",
    )

    out_path = PROJECT_ROOT / "artifacts" / "debug_rest_prob_features.png"
