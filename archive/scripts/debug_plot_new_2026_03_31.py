"""
Generate a debug plot for 'data/2026-03-31_17_07_37.json' showing:
...
def main() -> None:
    ...
    path = PROJECT_ROOT / "data" / "2026-03-31_17_07_37.json"
    signal, fs = loader.load_json(str(path), default_fs=125)
    ...
    # Feature traces on normalized signal
    ...
    fig = plot_ecg_debug(
        ...
        title="Debug: 2026-03-31_17_07_37 (prob + features)",
    )

    out_path = PROJECT_ROOT / "artifacts" / "debug_new_2026-03-31_17_07_37_prob_features.png"
